...
const starterPlaces = [
    ...
    description: "In 1947, a woman named Lyde Heatherington did in the house, causing her brother Edwin to contact a medium. When doing an seance and attempting to contact his sister, it is said that spiritual portals where opened, causing several spirits into the home, including one that disguises herself as a small girl named Emily.",
    scareLevel: 6,
    visited: false,
    },
    {
    ...
    description: "A bridge said to be haunted by a half-man half-goat figured called Goatman. It is said if you cross the bridge at night without headlights you will be met on the other side by the Goatman",
    scareLevel: 5,
    visited: false,
    },
    {
    ...
    description: "The bridge in the The Legend of Sleep Hollow that Ichabod Crane leads the Headless Horseman on a horseback chase through the woods in the dark of night.",
    scareLevel: 5,
    visited: false,
    },
    {
    ...
    description: "Named after Madame Delphine LaLaurie, it said she killed the workers who lived in the mansion, where the ghosts of her victims remain in the mansion.",
    scareLevel: 6,
    visited: false,
    },
    {
    ...
    description: "The home of Lizzie Borden and her family and the site of the famous unsolved double murder of Lizzie's father and stepmother Andrew and Abby Borden.",
    scareLevel: 6,
    visited: false,
    },
    {
    ...
    description: "Haunted by people who died during the yellow fever outbreak of 1897 while the building was used as a makeshift hospital, such as Lady in White, a woman dressed in white who resides on the upper floors.",
    scareLevel: 5,
    visited: false,
    },
    {
    ...
    description: "The location of Mothman, said to be seen in the area as large winged creature with glowing red eyes. He is said be seen near old the old WW2 bunkers that in the area.",
    scareLevel: 7,
    visited: false,
    },
    {
    ...
    description: "The site of during the Salem Witch Trials where hangings took place. It is said many innocent people died here and it is still haunted to this day.",
    scareLevel: 8,
    visited: false,
    },
    {
    ...
    description: "A lighthouse believed to still be haunted by it's keepers and other ghosts such as Peter Rasmussen and Joseph Andreu. The most famous ghosts are those of Eliza and Mary Pity, who died while playing with a cart that tumbled into the ocean, who still play to this day.",
    scareLevel: 6,
    visited: false,
    },
    {
    ...
    description: "An abandoned ghost town which was once the site of a mining operation. Over 18 men where killed here for stealing gold ore, and it is said to be haunted by their spirits to this day.",
    scareLevel: 6,
    visited: false,
    },
    {
    ...
    description: "Built on the site where famous thief Jim Robinson was publicly executed, it is said it was a prone to paranormal activity since it was built. This continued to grow as the Whaley family lived here, the family struck with numerous tragic deaths, as well as paranormal and spiritual encounters that continue today.",
    scareLevel: 6,
    visited: false,
    },
    {
